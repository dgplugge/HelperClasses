...
#End Region
    ...
    Public Shared Function GetString(ByVal key As String) As String
        Dim strTemp As String = CType(ConfigurationManager.AppSettings.Get(key), String)
        If strTemp = Nothing Then
            Return ""
        Else
            Return strTemp
    ...
    Public Shared Function GetInteger(ByVal key As String) As Integer
        ...
        Dim intTemp As Integer = CType(ConfigurationManager.AppSettings.Get(key), Integer)
