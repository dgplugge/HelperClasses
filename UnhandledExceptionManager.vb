...
Public Class UnhandledExceptionManager
    ...
    Private Const _strLogName As String = "UnhandledExceptionLog.log"
...
#End Region
    ...
    Private Shared Sub LoadConfigSettings()
        ...
        TakeScreenshot = GetConfigBoolean("TakeScreenshot", False)
        EmailScreenshot = GetConfigBoolean("EmailScreenshot", False)
        ...
        KillAppOnException = GetConfigBoolean("KillAppOnException", False)
    End Sub
    ...
    Private Shared Function FormatExceptionForUser(ByVal blnConsoleApp As Boolean) As String
        ...
        With objStringBuilder
            ...
            If _blnLogToEmail Then
                ...
                .Append(Environment.NewLine)
                .Append("   ")
                .Append(My.Settings.ExceptionEmail.ToString)
                .Append(Environment.NewLine)
            End If
            .Append(Environment.NewLine)
            .Append(Environment.NewLine)
    ...
    Private Shared Sub ThreadHandler()
        ...
        '       With objMailMessage
        '.To = My.Settings.ExceptionEmail.ToString
        '.Subject = "Unhandled Exception notification - " & _strExceptionType
        objReport.EmailText = _strException
        If _blnLogToScreenshot And _blnEmailIncludeScreenshot Then
            objReport.AttachList.Add(_strScreenshotFullPath)
        End If
        'End With
        Try
    ...
    Private Shared mAppVersion As String = ""
    Public Shared Property AppVersion As String
        Get
            Return mAppVersion
        End Get
    ...
    Private Shared Function GetConfigString(ByVal strKey As String, Optional ByVal strDefault As String = Nothing) As String
        Try
            Dim strTemp As String = CType(ConfigurationManager.AppSettings.Get(_strClassName & "/" & strKey), String)
