...
#Region "Private Variables and Enum Constants"
    ...
    Public ReadOnly Property Valid_User() As String
        Get
            Return m_username
        End Get
    End Property
    Private m_domain As String
    Public ReadOnly Property Valid_Domain() As String
        Get
            Return m_domain
        End Get
    End Property
    ...
    Private mIgnore As Boolean = True
...
#Region "Public Methods"
    ...
    <PermissionSetAttribute(SecurityAction.Demand, Name:="FullTrust")> _
    Public Sub ImpersonateStart()
        If (Not m_valid) Then Return
        If (mIgnore) Then Return
        Try
            tokenHandle = IntPtr.Zero
            ' Call LogonUser to obtain a handle to an access token.
            Dim returnValue As Boolean = LogonUser(m_username, m_domain, m_password, 2, 0, tokenHandle)
...
#End Region
    ...
    Public Sub New()
        ...
        mIgnore = My.User.IsAuthenticated
        Me.m_valid = mIgnore
